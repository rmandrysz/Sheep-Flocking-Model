...
plt.xlabel("Odległość Drapieżnika od centrum stada [Jednostki silnika Unity]")
plt.ylabel("Średnia odległość owiec od centrum stada [Jednostki silnika Unity]")
...
plt.legend()
plt.grid(True)
plt.savefig("FigMeanDistanceSim.svg", bbox_inches='tight', pad_inches=0, format="svg")
